                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {towerInfo.heroImages.map((image) => (
                      <motion.div
                        ...
                        className={`relative group border rounded-xl overflow-hidden bg-gray-100 cursor-move transition-all ${
                          draggingId === image._id ? 'opacity-50' : ''
                        }`}
                      >
            ...
            <div className="bg-white rounded-xl shadow p-6">
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className={`w-full py-2.5 px-4 rounded-lg font-medium transition-colors ${
                    !videoForm.youtubeId || !videoForm.title
                      ? 'bg-gray-300 text-gray-500 cursor-not-allowed'
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {towerInfo.videos.map((video) => (
                      <motion.div
                        ...
                        className={`border rounded-xl overflow-hidden bg-gray-100 cursor-move transition-all ${
                          draggingId === video._id ? 'opacity-50' : ''
                        }`}
                      >
