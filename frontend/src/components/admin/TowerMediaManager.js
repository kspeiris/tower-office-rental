    ...
    <div className="space-y-6">
          ...
          <div className="space-y-6">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-start">
                <HiExclamationCircle className="h-5 w-5 text-blue-600 mt-0.5 mr-3 flex-shrink-0" />
          ...
          <div className="space-y-4">
            ...
            {towerData?.featureImages?.length > 0 ? (
              ...
              <div className="text-center py-12 bg-gray-50 rounded-lg">
                <HiPhotograph className="h-16 w-16 text-gray-400 mx-auto mb-4" /> {/* FIXED: Changed from HiPhoto */}
      ...
      {activeTab === 'videos' && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-start">
                <HiExclamationCircle className="h-5 w-5 text-blue-600 mt-0.5 mr-3 flex-shrink-0" />
                <div className="text-sm text-blue-800">
                  <p className="font-medium mb-1">YouTube URL Formats:</p>
                  <ul className="list-disc list-inside space-y-1">
          ...
          {/* Video List */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-gray-900">Added Videos</h3>
            ...
            {towerData?.youtubeVideos?.length > 0 ? (
              ...
              <div className="text-center py-12 bg-gray-50 rounded-lg">
                <HiVideoCamera className="h-16 w-16 text-gray-400 mx-auto mb-4" />
