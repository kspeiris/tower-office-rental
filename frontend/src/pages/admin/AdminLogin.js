        ...
        >
          <div className="text-center">
            <div className="flex justify-center">
              <HiOfficeBuilding className="h-12 w-12 text-primary-600" aria-hidden="true" />
            </div>
              ...
              <div>
                ...
                <div className="mt-1 relative">
                  ...
                  <input
                    ...
                    disabled={isLoading}
                    className={`appearance-none block w-full pl-10 pr-3 py-2 border rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 sm:text-sm disabled:bg-gray-100 disabled:cursor-not-allowed ${
                      errors.email
              ...
              <div>
                ...
                <div className="mt-1 relative">
                  ...
                  <input
                    ...
                    disabled={isLoading}
                    className={`appearance-none block w-full pl-10 pr-10 py-2 border rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 sm:text-sm disabled:bg-gray-100 disabled:cursor-not-allowed ${
                      errors.password
                        ? 'border-red-300 focus:ring-red-500 focus:border-red-500'
                        : 'border-gray-300 focus:ring-primary-500 focus:border-primary-500'
                    }`}
