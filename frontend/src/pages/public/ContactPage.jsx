        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <motion.div
              ...
              className="mt-8 bg-gray-100 dark:bg-gray-800 rounded-xl p-6 transition-colors"
            >
                ...
                {({ values }) => (
                  <Form className="space-y-6">
                    ...
                    <div className="flex items-center">
                      ...
                      />
                      <label htmlFor="newsletter" className="ml-2 text-sm text-gray-700 dark:text-gray-300 transition-colors">
                    ...
                    <div className="pt-6 border-t">
                      ...
                      <p className="mt-3 text-sm text-gray-600 dark:text-gray-400 text-center transition-colors">
            ...
            >
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={index} className="border-b border-gray-200 dark:border-gray-800 pb-6 last:border-0 last:pb-0 transition-colors">
